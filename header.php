...
<html lang="en">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $url;?>/assets/img/icons/apple-touch-icon.png">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Robson Mendonça</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Desenvolvedor Web, Consultor e Voluntário em São Paulo, Brasil</p>
            </div>
        </header>
